...
# 读取ms4图
ms4_tif = TIFF.open('/home/gpu/Experiment/Remote data/image9/ms4.tif', mode='r')
...
# 读取pan图
pan_tif = TIFF.open('/home/gpu/Experiment/Remote data/image9/pan.tif', mode='r')
...
label_np = np.load('/home/gpu/Experiment/Remote data/image9/label.npy')
...
all_data = MyData(ms4, pan, ms4_self, pan_self, ms4_LL, pan_LL, the_matrix[2], the_matrix[0], the_matrix[1],
                  Ms4_patch_size)
all_data_loader = DataLoader(dataset=all_data, batch_size=1024, shuffle=False, num_workers=0)
