...
# 读取ms4图
ms4_tif = TIFF.open('/home/gpu/Experiment/Remote data/image5/ms4.tif', mode='r')
...
cA1=cv2.resize(cA1,(4548,4541))
cA2=cv2.resize(cA2,(4548,4541))
cA3=cv2.resize(cA3,(4548,4541))
cA4=cv2.resize(cA4,(4548,4541))
cH1=cv2.resize(cH1,(4548,4541))
cH2=cv2.resize(cH2,(4548,4541))
cH3=cv2.resize(cH3,(4548,4541))
cH4=cv2.resize(cH4,(4548,4541))
cV1=cv2.resize(cV1,(4548,4541))
cV2=cv2.resize(cV2,(4548,4541))
cV3=cv2.resize(cV3,(4548,4541))
cV4=cv2.resize(cV4,(4548,4541))
cD1=cv2.resize(cD1,(4548,4541))
cD2=cv2.resize(cD2,(4548,4541))
cD3=cv2.resize(cD3,(4548,4541))
cD4=cv2.resize(cD4,(4548,4541))
print(cA1.shape)
# plt.figure(figsize=(8,8))
# plt.subplot(2,2,1)
# plt.imshow(cA1)
...
# 读取pan图
pan_tif = TIFF.open('/home/gpu/Experiment/Remote data/image5/pan.tif', mode='r')
...
label_np = np.load('/home/gpu/Experiment/Remote data/image5/label.npy')
...
all_data = MyData(ms4, pan, ms4_self, pan_self, ms4_LL, pan_LL, the_matrix[2], the_matrix[0], the_matrix[1],
                  Ms4_patch_size)
all_data_loader = DataLoader(dataset=all_data, batch_size=1024, shuffle=True, num_workers=0)
...
test_loader = DataLoader(dataset=test_dataset, batch_size=1024, shuffle=False, num_workers=0)
