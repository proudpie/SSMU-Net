...
# 读取ms4图
ms4_tif = TIFF.open('/home/gpu/Experiment/Remote data/image10/ms4.tif', mode='r')
...
cA1=cv2.resize(cA1,(7300,6905))
cA2=cv2.resize(cA2,(7300,6905))
cA3=cv2.resize(cA3,(7300,6905))
cA4=cv2.resize(cA4,(7300,6905))
cH1=cv2.resize(cH1,(7300,6905))
cH2=cv2.resize(cH2,(7300,6905))
cH3=cv2.resize(cH3,(7300,6905))
cH4=cv2.resize(cH4,(7300,6905))
cV1=cv2.resize(cV1,(7300,6905))
cV2=cv2.resize(cV2,(7300,6905))
cV3=cv2.resize(cV3,(7300,6905))
cV4=cv2.resize(cV4,(7300,6905))
cD1=cv2.resize(cD1,(7300,6905))
cD2=cv2.resize(cD2,(7300,6905))
cD3=cv2.resize(cD3,(7300,6905))
cD4=cv2.resize(cD4,(7300,6905))
print(cA1.shape)
#plt.figure(figsize=(8,8))
#plt.subplot(2,2,1)
#plt.imshow(cA1)
...
# 读取pan图
pan_tif = TIFF.open('/home/gpu/Experiment/Remote data/image10/pan.tif', mode='r')
...
label_np = np.load('/home/gpu/Experiment/Remote data/image10/label.npy')
...
for i in range(2):
    ...
    print(matrix_[i][len(matrix_[i])-1])
...
all_data = MyData(ms4,pan,ms4_self,pan_self,ms4_LL,pan_LL,the_matrix[2],the_matrix[0],the_matrix[1],Ms4_patch_size)
all_data_loader = DataLoader(dataset=all_data, batch_size=2048, shuffle=False,num_workers=0)
...
test_loader = DataLoader(dataset=test_dataset,batch_size=512, shuffle=False,num_workers=0)

verify_data = Subset(all_data,indices=matrix_[1])
verify_loader = DataLoader(dataset=verify_data,batch_size=1024, shuffle=False,num_workers=0)
